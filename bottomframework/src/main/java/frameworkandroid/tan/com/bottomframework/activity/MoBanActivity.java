 ...
 * ctrl+shift+-  全部折叠
 */
//@ContentView(R.layout.activity_moban)
public class MoBanActivity extends TitleBarActivity {
    ...
    @OnClick(R.id.button)
    void btn_jump(View v) {
        startActivityByClass(BaseDistinctionActivity.class);
    }*/
...
private class MobanModel<T> extends BaseModel {
    ...
    public void requestDistrict(final DataListener dataListener) {
          ...
          /*  String json = AssetsUtils.getAssetsData(mContext, "FisheriesProduct/user/BaseDistinctionActivity.txt");
            ...
            List<CategoryChildren>  entitys = (List<CategoryChildren>) JsonUtil.convertJsonToObject1(json, type);
