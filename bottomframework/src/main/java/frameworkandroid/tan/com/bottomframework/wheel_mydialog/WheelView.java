...
public class WheelView extends View {
	...
	private static final String VALUE_TEXT_COLOR = "#2caaa6";
...
//		setBackgroundResource(R.drawable.edittextbg);
	}
...
//	}
	...
	private void drawValue(Canvas canvas) {
		valuePaint.setColor(Color.parseColor(VALUE_TEXT_COLOR));
	...
	private void drawItems(Canvas canvas) {
		...
		itemsPaint.setColor(Color.parseColor(ITEMS_TEXT_COLOR));
