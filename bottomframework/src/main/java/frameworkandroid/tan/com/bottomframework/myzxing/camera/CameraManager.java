...
package frameworkandroid.tan.com.bottomframework.myzxing.camera;
...
public final class CameraManager {
	...
	/**
	 * Calculates the framing rect which the UI should draw to show the FisheriesProduct.user
	 * where to place the barcode. This target helps with alignment as well as
	 * forces the FisheriesProduct.user to hold the device far enough away to ensure the image
	 * will be in focus.
	 *
